...
ActiveRecord::Schema.define(version: 2026_09_12_010000) do
  ...
  create_table "deals", force: :cascade do |t|
    ...
    t.string "homepage_featured_locale"
    ...
    t.index ["homepage_featured_locale"], name: "index_deals_on_homepage_featured_locale", unique: true, where: "homepage_featured_locale IS NOT NULL"
